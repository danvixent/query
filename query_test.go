...
func BenchmarkUpdateBuilder_Update(t *testing.B) {
	tests := []struct {
		name string
		want string
		exec func() string
...
func BenchmarkSelectBuilder_Select(t *testing.T) {
	tests := []struct {
		name string
		want string
		exec func() string
...
func BenchmarkJoinBuilder_Join(t *testing.T) {
	tests := []struct {
		name string
		want string
		exec func() string
...
func BenchmarkInsertBuilder_Insert(t *testing.T) {
	tests := []struct {
		name string
		want string
		exec func() string
...
func BenchmarkDeleteBuilder_Delete(t *testing.T) {
	tests := []struct {
		name string
		want string
		exec func() string
